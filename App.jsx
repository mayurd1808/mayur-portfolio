...
const USER_DATA = {
  ...
  github: "https://github.com/mayurd1808/mayur-portfolio",
};
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className={`flex justify-between items-center rounded-2xl transition-all duration-500 ${scrolled ? 'bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 px-6 py-3 shadow-xl shadow-black/5' : 'px-0'}`}>
              <div className="text-2xl font-black flex items-center gap-2 group cursor-default">
                ...
                <span className="hidden sm:block tracking-tighter">Mayur<span className="text-indigo-600"> Deshmukh</span></span>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-8">
                ...
                <a 
                       ...
                       download
                      className="px-8 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl font-bold flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all"
>
